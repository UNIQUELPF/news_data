...
class FranceLinformeSpider(FranceBaseSpider):
    name = "france_linforme_subscription"
    subscription_required = True
    access_note = "订阅/付费墙网站；仅采集可访问的公开正文，正文不全时需标记"
    allowed_domains = ['linforme.com']
    start_urls = ['https://www.linforme.com/tech-telecom/']
