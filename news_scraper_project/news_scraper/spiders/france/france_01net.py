...
class France01netSpider(FranceBaseSpider):
    name = "france_01net"
    allowed_domains = ['01net.com']
    start_urls = ['https://www.01net.com/actualites/']
    ...
    async def start(self):
        ...
        for url in self.start_urls:
            yield scrapy.Request(url, callback=self.parse_listing, meta=meta, dont_filter=True)
