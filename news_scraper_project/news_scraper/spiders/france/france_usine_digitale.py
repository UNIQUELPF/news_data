...
class FranceUsineDigitaleSpider(FranceBaseSpider):
    name = "france_usine_digitale"
    allowed_domains = ['usine-digitale.fr']
    start_urls = ['https://www.usine-digitale.fr/intelligence-artificielle/']
