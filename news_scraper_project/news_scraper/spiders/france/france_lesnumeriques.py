...
class FranceLesnumeriquesSpider(FranceBaseSpider):
    name = "france_lesnumeriques"
    allowed_domains = ['lesnumeriques.com']
    start_urls = ['https://www.lesnumeriques.com/actualites']
