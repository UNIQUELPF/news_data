...
class FranceUsinenouvelleSpider(FranceBaseSpider):
    name = "france_usinenouvelle"
    allowed_domains = ['usinenouvelle.com']
    start_urls = ['https://www.usinenouvelle.com/international/commerce-international/']
