...
class FranceAutoritedelaconcurrenceSpider(FranceBaseSpider):
    name = "france_autoritedelaconcurrence"
    allowed_domains = ['autoritedelaconcurrence.fr']
    start_urls = ['https://www.autoritedelaconcurrence.fr/fr/actualites']
