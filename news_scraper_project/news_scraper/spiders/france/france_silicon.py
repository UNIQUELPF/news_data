...
class FranceSiliconSpider(FranceBaseSpider):
    name = "france_silicon"
    allowed_domains = ['silicon.fr']
    start_urls = ['https://www.silicon.fr/archive/2']
    ...
    def parse_listing(self, response):
        ...
        for a_sel in all_links:
            ...
            # Only match actual article URLs ending with a hyphen and 6 digits
            import re
            if not re.search(r'-\d{6}$', url.rstrip('/')):
                continue
