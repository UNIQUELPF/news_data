...
class JpAsahiSpider(SmartSpider):
    name = 'jp_asahi'
    country_code = 'JPN'
    country = '日本'
    language = 'ja'
    ...
    start_urls = ['https://www.asahi.com/business/list/?iref=pc_business_top']

    use_curl_cffi = False
    strict_date_required = False
    fallback_content_selector = 'div.ArticleText, article'
