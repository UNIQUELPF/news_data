...
class JpMlitSpider(SmartSpider):
    name = 'jp_mlit'
    country_code = 'JPN'
    country = '日本'
    language = 'ja'
    ...
    async def start(self):
        ...
        urls = [
            f'https://www.mlit.go.jp/report/press/houdou{now.year}{month:02d}.html',
            f'https://www.mlit.go.jp/report/press/houdou{prev_year}{prev_month:02d}.html',
        ]
        for url in urls:
    ...
    def parse_detail(self, response):
        ...
        item['author'] = 'Ministry of Land Infrastructure'
