...
class JpNikkeiSpider(SmartSpider):
    name = 'jp_nikkei_subscription'
    ...
    start_urls = ['https://www.nikkei.com/topics/24032801']

    use_curl_cffi = False
    strict_date_required = False
    fallback_content_selector = 'article, .js-article-body'
