...
class JpBusinessInsiderSpider(SmartSpider):
    name = 'jp_business_insider'
    country_code = 'JPN'
    country = '日本'
    language = 'ja'
    source_timezone = 'Asia/Tokyo'
    allowed_domains = ['businessinsider.jp']
    start_urls = ['https://www.businessinsider.jp/articles/business/']

    use_curl_cffi = False
    strict_date_required = False
    fallback_content_selector = 'article, .p-post-content'
    ...
    def parse_detail(self, response):
        ...
        item['author'] = 'Business Insider Japan'
