...
class JpImpressWatchSpider(SmartSpider):
    name = 'jp_impress_watch'
    country_code = 'JPN'
    country = '日本'
    language = 'ja'
    source_timezone = 'Asia/Tokyo'
    allowed_domains = ['watch.impress.co.jp', 'impress.co.jp']
    start_urls = ['https://www.watch.impress.co.jp/category/business/']

    use_curl_cffi = False
    strict_date_required = False
    fallback_content_selector = 'article, .article-body'
