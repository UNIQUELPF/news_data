...
class JpCNETSpider(SmartSpider):
    name = 'jp_cnet'
    country_code = 'JPN'
    country = '日本'
    language = 'ja'
    source_timezone = 'Asia/Tokyo'
    allowed_domains = ['japan.cnet.com']
    start_urls = ['https://japan.cnet.com/news/']

    use_curl_cffi = False
    strict_date_required = False
    fallback_content_selector = 'div.story-body, article'
