...
class JpYomiuriSpider(SmartSpider):
    name = 'jp_yomiuri'
    country_code = 'JPN'
    country = '日本'
    language = 'ja'
    ...
    start_urls = ['https://www.yomiuri.co.jp/column/economy03/']

    use_curl_cffi = False
    strict_date_required = False
    fallback_content_selector = 'div.article-body, article'
