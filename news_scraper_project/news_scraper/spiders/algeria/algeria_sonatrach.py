...
class AlgeriaSonatrachSpider(scrapy.Spider):
    ...
    def parse_listing(self, response):
        ...
        for href in article_links:
            ...
            if full_url in self.seen_urls or "/category/" in full_url or "/wp-content/uploads/" in full_url:
                continue
