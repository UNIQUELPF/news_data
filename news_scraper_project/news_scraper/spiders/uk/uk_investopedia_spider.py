...
class UkInvestopediaSpider(SmartSpider):
    name = "uk_investopedia"
    allowed_domains = ['investopedia.com']
    start_urls = ['https://www.investopedia.com/economic-news-5218422']
    ...
    def parse_detail(self, response):
        ...
        item["author"] = "Investopedia"
        item["section"] = "Economic News"
