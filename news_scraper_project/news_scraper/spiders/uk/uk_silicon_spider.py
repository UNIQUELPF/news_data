...
class UkSiliconSpider(SmartSpider):
    name = "uk_silicon"
    allowed_domains = ['silicon.co.uk']
    start_urls = ['https://www.silicon.co.uk/news/e-marketing']
    ...
    def parse_detail(self, response):
        ...
        item["author"] = "Silicon UK"
        item["section"] = "E-marketing"
