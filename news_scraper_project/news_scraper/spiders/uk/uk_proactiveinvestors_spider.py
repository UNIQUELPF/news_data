...
class UkProactiveinvestorsSpider(SmartSpider):
    name = "uk_proactiveinvestors"
    allowed_domains = ['proactiveinvestors.co.uk']
    start_urls = ['https://www.proactiveinvestors.co.uk/archives/niche/sectors/finance/194']
    ...
    def parse_detail(self, response):
        ...
        item["author"] = "Proactive Investors"
