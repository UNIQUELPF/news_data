...
class UkWsjGlobalSpider(SmartSpider):
    name = "uk_wsj_global_subscription"
    subscription_required = True
    access_note = "订阅/付费墙网站；仅采集可访问的公开正文，正文不全时需标记"
    allowed_domains = ['wsj.com']
    start_urls = ['https://www.wsj.com/economy/global?mod=economy_feat1_global_viewall']
    ...
    def parse_detail(self, response):
        ...
        item["author"] = "Wall Street Journal"
        item["section"] = "Global Economy"
