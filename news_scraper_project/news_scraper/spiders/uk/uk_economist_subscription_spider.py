...
class UkEconomistSpider(SmartSpider):
    name = "uk_economist_subscription"
    subscription_required = True
    access_note = "订阅/付费墙网站；仅采集可访问的公开正文，正文不全时需标记"
    allowed_domains = ['economist.com']
    start_urls = ['https://www.economist.com/topics/finance-and-economics']
    ...
    def parse_detail(self, response):
        ...
        item["author"] = "The Economist"
        item["section"] = "Finance and Economics"
