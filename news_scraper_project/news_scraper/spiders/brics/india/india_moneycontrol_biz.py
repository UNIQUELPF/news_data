...
class IndiaMoneycontrolBizSpider(SitemapSpider):
    ...
    # Only follow /news/business/ urls, but ignore /economy/ which is covered by the other spider
    sitemap_rules = [
        # Regex explanation: match /news/business/, optionally anything, EXCEPT if it contains 'economy/'
        (r'/news/business/(?!economy/).+', 'parse_detail'),
    ]

    def __init__(self, *args, **kwargs):
        super(IndiaMoneycontrolBizSpider, self).__init__(*args, **kwargs)
    ...
    def parse_detail(self, response):
        ...
        # Skip gracefully instead of killing spider on sitemaps
