...
class BrazilANPSpider(SmartSpider):
    ...
    fallback_content_selector = "div#content"  # Plone CMS standard content area
    ...
    def parse_list(self, response):
        ...
        for item in items:
            ...
            # Use strict parsing to avoid ISO conflicts and tzinfo errors
            # It's highly recommended to parse_to_utc with parsed datetime object
            import dateparser
        ...
        if has_valid_item_in_window:
            ...
            if start_index < 3000:
                next_url = f"https://www.gov.br/anp/pt-br/canais_atendimento/imprensa/noticias-comunicados?b_start:int={start_index}"
    ...
    def parse_detail(self, response):
        ...
        # Refine fallback date logic if auto_parse_item failed to extract exact time
        # The list page gives us DD/MM/YYYY, but detail page has time like "28/04/2026 18h15"
        ...
        # Incremental check is done in pipeline/spider via should_process, 
        # but auto_parse_item already has the hint and handles everything nicely.
        yield item
