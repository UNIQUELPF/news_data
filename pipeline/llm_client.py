    ...
    *,
    ...
    parsed = _chat_completion_json(
        system_prompt=(
            ...
            "TASK 1: TRANSLATION\n"
            "- Translate into professional Simplified Chinese.\n"
            "- CRITICAL: You MUST preserve the exact paragraph structure of the source text. DO NOT merge paragraphs into a single block. Each paragraph in the source MUST be a separate paragraph in the translation.\n"
            "- Maintain all Markdown formatting (headings, lists, bolding).\n"
            ...
            "- content_translated: translated full content in Simplified Chinese. YOU MUST USE DOUBLE NEWLINES (\\n\\n) BETWEEN ALL PARAGRAPHS. Example: \"Paragraph 1.\\n\\nParagraph 2.\"\n"
