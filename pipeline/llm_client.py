...
def translate_article_content(
    *,
    ...
    parsed = _chat_completion_json(
        system_prompt=(
            "You are a professional policy and business news translator and analyst. "
            "Translate into concise, accurate Simplified Chinese. "
            "Also classify the news article and extract key entities.\n\n"
            "Return strict JSON with the following keys:\n"
            "- title_translated: translated title\n"
            "- summary_translated: 2-4 sentence Chinese summary\n"
            "- content_translated: translated full content\n"
            "- category: one of [政治, 经济, 军事, 法规, 科技, 社会, 环境, 其他]\n"
            "  Use these mapping rules: finance/trade/industry/energy -> 经济; "
            "law/regulation/compliance -> 法规; culture/education/sports/public livelihood -> 社会; "
            "ecology/climate/pollution -> 环境.\n"
            "- involved_companies: comma-separated list of company/organization names mentioned in the article "
            "(use Chinese names when well-known, e.g. 苹果公司, 谷歌, 特斯拉; otherwise keep original name). "
            "If no companies are mentioned, return empty string."
        ),
        user_prompt=(
